...
class ImageCardViewActivity : ComponentActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        setContent {
            val painter = painterResource(id = R.drawable.snorkelling)
            val description = "Snorkelling in the waters"
            val title = "He is enjoying himself"
